<form class="custom-form" id="register-workshop-evolution-form" method="POST" enctype="multipart/form-data">
    <div class="form-row">
    ...
    <div class="form-group">
        ...
        foreach ($evolutionEvents as $evolutionEvent) {
            if ($evolutionEvent->eventType == eventType::workshop && $evolutionEvent->eventRegistrationsOpen == true) {
                echo '
    ...
    <!-- submit -->
    <input type="hidden" name="eventType" value="workshop">
