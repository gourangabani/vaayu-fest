<form class="custom-form" id="register-team-write-camera-action-evolution-form" method="POST" enctype="multipart/form-data">
    <div class="form-row">
    ...
    <div class="form-group">
        <h3 class="mb-3">
            Details of your team member [Optional]:
        </h3>
        <div class="form-row">
            <div class="col-md-6 mb-3">
                <input type="text" class="form-control" placeholder="< Name? />" name="team-member-name[]" />
            </div>
            <div class="col-md-6 mb-3 input-group">
                <div class="input-group-prepend">
                    <div class="input-group-text">+91</div>
                </div>
                <input type="tel" class="form-control" placeholder="< Mobile Number. />" name="team-member-mobile[]" />
            </div>
        </div>
    </div>
    <!-- submit -->
    <input type="hidden" name="eventType" value="team">
    <input type="hidden" name="event" value="write-camera-action">
