...
<head>
    ...
    <meta http-equiv="refresh" content="3;url=https://youtu.be/od18F9nLoxg" />
    <title>
        Vaayu Fest - Redirect
    </title>
        ...
        <div class="container h-100">
            <div class="d-flex h-100 text-center align-items-end">
                <div class="w-100 text-white">
                    <h6 class="mb-5">
                        Redirecting... click <a href="https://www.youtube.com/watch?v=od18F9nLoxg&feature=youtu.be">here</a> if not redirected in 3 seconds.
                    </h6>
                </div>
            </div>
        </div>
