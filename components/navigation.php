...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block"><img class="img-fluid mx-auto mb-2" src="<?php $_SERVER['DOCUMENT_ROOT'] . '/' . $base; ?>/vaayu-fest/assets/img/vaayu-20-logo-transparent.png" alt="Logo" /></span>
    </a>
    ...
    if (basename($_SERVER['REQUEST_URI']) != 'index.php') {
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="' . $_SERVER['DOCUMENT_ROOT'] . '/vaayu-fest/index.php">
                        Home
                    </a>
                </li>
            </ul>
