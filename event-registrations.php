...
<head>
    ...
    <title>
        Vaayu Fest - Event Registrations
    </title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-11 col-md-11 col-sm-12">
                    <div class="typeform-widget" data-url="https://form.typeform.com/to/jZNePnMP?typeform-medium=embed-snippet" style="width: 100%; height: 500px;"></div>
                    <script>
                        (function() {
