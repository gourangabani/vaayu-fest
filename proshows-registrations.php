...
<head>
    ...
    <title>
        Vaayu Fest - Proshows Registrations
    </title>
...
<body id="page-top">
    ...
    <!-- registrations -->
    <section id="userRegistrationSection" class="customSection">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-11 col-md-11 col-sm-12">
                    <div class="typeform-widget" data-url="https://form.typeform.com/to/kb3f9Dnt?typeform-medium=embed-snippet" style="width: 100%; height: 500px;"></div>
                    <script>
                        (function() {
